...
, 
{id = 120, icon = "Icon/Head/head_12001_S", name = "카나체", landmark = "아모르 성휘 부속대학 제3 강의동 교직원실", signature = "숙제가 뭔지 묻는 건 모두 답장 안 함"}
, 
{id = 123, icon = "Icon/Head/head_12301_S", name = "안즈", landmark = "잇시 마을", signature = "갸우"}
, 
{id = 125, icon = "Icon/Head/head_12501_S", name = "프리지아", landmark = "벨린 10번가 9번지", signature = "보통은 화내지 않음"}
, 
{id = 126, icon = "Icon/Head/head_12601_S", name = "플로라", landmark = "플라비오 성 밖 남부 숲", signature = "공연 보러 오세요"}
, 
...
, 
{id = 134, icon = "Icon/Head/head_13401_S", name = "후유카", landmark = "필리에 외곽 동부 숲 하나사키 여단", signature = "보고합니다"}
, 
...
, 
{id = 9999, icon = "Icon/Head/head_npc99901_S", name = "비타", landmark = "제공하신 모드로 파일을 찾을 수 없습니다", signature = "말 초기화 완료, 자원 할당 완료, 프로세스 준비 완료"}
}
