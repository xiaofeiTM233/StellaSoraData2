...
local GameState = {Prepare = 1, Dealing = 2, Flip = 3, Settlement = 4, Complete = 5}
...
PenguinLevel.ParseConfigData = function(self)
  ...
  local func_ForEach_Rank = function(mapData)
    ...
    (self.mapHandRankRule)[mapData.Order] = {Id = mapData.Id, SuitCount = mapData.SuitCount, Value = mapData.Value, Ratio = mapData.Ratio}
  end
...
PenguinLevel.GiveupGame = function(self)
...
PenguinLevel.RunGameState = function(self)
  -- function num : 0_9 , upvalues : GameState
...
PenguinLevel.QuitGameState = function(self)
...
PenguinLevel.QuitState_Prepare = function(self)
...
PenguinLevel.AddRound = function(self)
  ...
  ;
  (EventManager.Hit)(EventId.OpenMessageBox, {nType = (AllEnum.MessageBox).Tips, bPositive = true, sContent = (EventManager.Hit)(EventId.OpenMessageBox, orderedFormat((ConfigTable.GetUIText)("PenguinCard_AddRoundSuccess"), self.nRoundLimit))})
  ;
...
PenguinLevel.AddSlot = function(self)
  ...
  self:ChangeScore(-1 * nCost)
  ;
  (EventManager.Hit)(EventId.OpenMessageBox, {nType = (AllEnum.MessageBox).Tips, bPositive = true, sContent = (EventManager.Hit)(EventId.OpenMessageBox, orderedFormat((ConfigTable.GetUIText)("PenguinCard_AddSlotSuccess"), self.nSlotCount))})
  ;
...
PenguinLevel.AddRoll = function(self)
  ...
  self:ChangeScore(-1 * nCost)
  ;
  (EventManager.Hit)(EventId.OpenMessageBox, {nType = (AllEnum.MessageBox).Tips, bPositive = true, sContent = (EventManager.Hit)(EventId.OpenMessageBox, orderedFormat((ConfigTable.GetUIText)("PenguinCard_AddRollSuccess"), self.nBuyLimit))})
  ;
...
PenguinLevel.CreatePenguinCard = function(self, nId)
  -- function num : 0_27 , upvalues : _ENV, PenguinCard
  local mapCard = nil
...
PenguinLevel.QuitState_Dealing = function(self)
  -- function num : 0_29
end
...
PenguinLevel.QuitState_Flip = function(self)
  -- function num : 0_31
  self:StopAuto()
end
...
PenguinLevel.ChangeRoundScore = function(self, nAddValue, nAddRatio, nAddMultiRatio)
...
PenguinLevel.QuitState_Settlement = function(self)
  -- function num : 0_37
  self:StopAuto()
...
PenguinLevel.RunState_Complete = function(self)
...
PenguinLevel.SetAutoState = function(self, bAuto)
  -- function num : 0_44 , upvalues : LocalData
  self.bAuto = bAuto
  ;
...
PenguinLevel.PlayAuto = function(self, bClick)
  -- function num : 0_46 , upvalues : GameState, _ENV
  ...
  if self.nGameState == GameState.Flip then
    ...
    -- function num : 0_46_0 , upvalues : self, j
    self:ShowBaseCard(j)
  end
)
          ;
...
PenguinLevel.TriggerPenguinCard = function(self, nTriggerPhase, mapTriggerSource)
  ...
  local callback = function(nEffectType, tbEffectParam)
    -- function num : 0_53_0 , upvalues : _ENV, self, mapTriggerSource
