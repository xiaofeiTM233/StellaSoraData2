...
WinterNight_10105Data.Init = function(self)
  -- function num : 0_0
  self.tbAllActivity = {}
...
WinterNight_10105Data.ParseActivity = function(self)
...
WinterNight_10105Data.GetActivityDataByIndex = function(self, nIndex)
...
WinterNight_10105Data.PlayCG = function(self)
  -- function num : 0_3
  self:SendMsg_CG_READ(self.nCGActivityId)
end

WinterNight_10105Data.GetActivityGroupCGPlayed = function(self)
...
WinterNight_10105Data.IsActivityInActivityGroup = function(self, nActivityId)
...
WinterNight_10105Data.SendMsg_CG_READ = function(self, nActivityId)
